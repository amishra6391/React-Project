...
import './teacher.css';     // this css comming from Teacher deatle
    const Fourthclass=(propes)=>{
        return(
            <>          {/* this page css comming from the Teacher css */}
                <div className="temp">
                        ...
                        <div className='teacher_box'>
                            ...
                            <div className="teacher_deta">
                                <div className="linebreak">
                                    <b>  Name:-</b>{propes.teaname}
                                </div>
                                <div className="linebreak">
                                    <b>Experince:- </b>{propes.teaexp}
                                </div>
                                <div className="linebreak">
                                    <b>Working Science:- </b>{propes.sciencethiscollege}
                                </div>
                                <div className="linebreak">
